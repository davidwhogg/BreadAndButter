...
Louisville's theorem (so no Jacobian appears), and defined $N(x\given
...
[technically this likelihood is good for one star.  Why do we require
  two?  Degeneracies.]

[priors on all nuisance parameters.]
